...
def write_database(column_index):
   ...
   with open("/scratch/project_2001640/ABCD_fMRI/csc_fmri/database_xcpd.txt", "r") as f:
       lines = f.readlines()
   ...
   with open("/scratch/project_2001640/ABCD_fMRI/csc_fmri/database_xcpd.txt", "w") as f:
        f.writelines(lines)
