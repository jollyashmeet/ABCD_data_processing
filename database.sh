...
#Jolly, 2023
#August, 2023
#script to create the database text file
...
output_file="/scratch/project_2001640/ABCD_fMRI/csc_fmri/database.txt"
...
#    echo -e "$subject\tN/A\tN/A\tN/A\tN/A\tN/A\tN/A\tN/A\tN/A\tN/A" >> "$output_file"
