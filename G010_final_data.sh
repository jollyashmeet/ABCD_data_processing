...
file1="/scratch/project_2001640/ABCD_fMRI/site_data/G010_site.txt"
file2="/scratch/project_2001640/ABCD_fMRI/csc_fmri/scripts/downcmd_txt_files/G010_faulty_subs.txt"
merged_file="./downcmd_txt_files/G010_final_data.txt"
...
for ((batch=1; batch<=total_batches; batch++)); do
    ...
    output_file="/scratch/project_2001640/ABCD_fMRI/csc_fmri/scripts/downcmd_txt_files/G010_final_data${batch}.txt"
